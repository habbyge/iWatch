 ...
 * @since 1.0
 * @version $Id: StringUtil.java 1199894 2011-11-09 17:53:59Z ggregory $
 */
//@Immutable
public class StringUtil {
    ...
    public static boolean equalsIgnoreCase(CharSequence str1, CharSequence str2) {
        if (str1 == null || str2 == null) {
            ...
            return CharSequenceUtil.regionMatches(str1, true, 0, str2, 0, Math.max(str1.length(), str2.length()));
        }
    }
    ...
    private static int ordinalIndexOf(CharSequence str, CharSequence searchStr, int ordinal, boolean lastIndex) {
        ...
        do {
            if (lastIndex) {
                index = CharSequenceUtil.lastIndexOf(str, searchStr, index - 1);
            } else {
                index = CharSequenceUtil.indexOf(str, searchStr, index + 1);
            }
            if (index < 0) {
                return index;
            }
     ...
     *  StringUtil.replaceEach("abcde", new String[]{"ab", "d"}, new String[]{"d", "ab"}, true) = IllegalStateException
     ...
     *
     * <pre>
     * StringUtil.repeat(0, 'e')  = ""
     * StringUtil.repeat(3, 'e')  = "eee"
     * StringUtil.repeat(-2, 'e') = ""
     * </pre>
     *
    ...
    public static boolean isAsciiPrintable(CharSequence cs) {
        ...
        int sz = cs.length();
        for (int i = 0; i < sz; i++) {
            if (CharUtil.isAsciiPrintable(cs.charAt(i)) == false) {
                return false;
            }
        }
        return true;
