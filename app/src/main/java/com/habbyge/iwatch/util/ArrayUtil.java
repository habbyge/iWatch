 ...
 * <p>#ThreadSafe#</p>
 * @since 2.0
 * @version $Id: ArrayUtil.java 1154216 2011-08-05 13:57:16Z mbenson $
 */
public class ArrayUtil {
     ...
     * Instead, the class should be used as <code>ArrayUtil.clone(new int[] {2})</code>.</p>
     *
     ...
     * Map colorMap = MapUtil.toMap(new String[][] {{
     *     {"RED", "#FF0000"},
     *     {"GREEN", "#00FF00"},
     *     {"BLUE", "#0000FF"}});
     * </pre>
